                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-5">
                                <div class="card shadow mb-2 pb-0">
                                    <!-- Card Header - Dropdown -->
                                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <#if demographicsURL??>
                                            <input type="hidden" value="${demographicsURL.hash}" class="url-qr" id="url-qr">
                                        </#if>
                                        <h6 class="m-0 font-weight-bold text-primary">C&oacute;digo QR</h6>
                                    </div>
                                    <!-- Card Body -->
                                ...
                                <div>
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#basicExampleModal" style="height: 40px; width:100%;">IP's de Visitas</button>
                                </div>
                            </div>
                        </div>
